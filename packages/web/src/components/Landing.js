                ...
                <div className="flex-1 p-6">
                  <a className="block mt-2 rounded focus:outline-none focus:ring focus:ring-offset-4" href="https://brace.to" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      Your bookmark manager with privacy at heart. Brace.to helps you save links to everything and visit them later easily anytime on your any devices.
                    </p>
                  </a>
                </div>
                <div className="mt-6">
              ...
              <div className="flex-1 bg-white flex flex-col justify-between divide-y divide-gray-200">
                <div className="flex-1 p-6">
                  <a className="block mt-2 rounded focus:outline-none focus:ring focus:ring-offset-4" href="https://justnote.cc" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-base text-gray-500">
                      Justnote is a privacy-focused note taking app that you can use it easily, take a note rapidly, and importantly, have full control of your data.
                    </p>
                  </a>
                </div>
                <div className="mt-6">
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
              <div className="pt-12 sm:pt-16 lg:pt-20">
                ...
                <div className="mt-6 text-gray-500 space-y-6">
                  <p className="text-lg">
                    A technology that allow you to truly own your ids and your data
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="py-44">
          <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
            <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
              <div>
                <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                  To give the best experience to our users.
                </h2>
                <p className="mt-6 max-w-3xl text-lg leading-7 text-gray-500">
                  Safty, Privacy, and Convenience are all you can get.
                </p>
              </div>
            </div>
          </div>
