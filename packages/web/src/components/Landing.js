          ...
          <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
              <div className="pt-12 sm:pt-16 lg:pt-20">
                <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Utilizing Web3 technology from <a className="text-indigo-600 rounded hover:underline focus:outline-none focus:ring" href="https://www.hiro.so/stacks-js" target="_blank" rel="noreferrer">Stacks</a></h2>
              ...
              <div className="relative">
                <div className="text-left sm:text-center">
                  ...
                  <p className="mt-6 mx-auto max-w-2xl text-lg text-gray-500">
                    <a className="rounded hover:underline focus:outline-none focus:ring" href="&#109;&#097;&#105;&#108;&#116;&#111;:&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#064;&#115;&#116;&#120;&#097;&#112;&#112;&#115;&#046;&#099;&#111;&#109;"><span className="e-mail" data-user="troppus" data-website="moc.sppaxts"></span></a>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 sm:flex sm:items-end sm:justify-between lg:px-8">
          ...
          <div className="mt-8 md:mt-0">
            <div className="flex justify-center sm:justify-end">
              <a className="text-gray-400 rounded p-1 hover:text-gray-500 focus:outline-none focus:ring" href="https://medium.com/@stxapps" target="_blank" rel="noreferrer">
                <span className="sr-only">Medium</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 1043.63 592.71" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <a className="ml-4 text-gray-400 rounded p-1 hover:text-gray-500 focus:outline-none focus:ring" href="https://github.com/stxapps" target="_blank" rel="noreferrer">
